          ...
          <div className="flex flex-wrap items-end justify-between gap-4 mt-2">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={playing ? 'btn-neon text-xs py-2 px-6' : 'btn-solid-cyan text-xs py-2 px-6'}
              >
                {playing ? '⏸ PAUSAR' : '▶ AUTO-PLAY'}
              </button>
              <button
                onClick={() => { setMintedNfts([]); goTo(0); setPlaying(false); }}
                className="text-white/30 hover:text-white/60 text-xs font-mono transition-colors border border-white/10 hover:border-white/20 px-4 py-2 rounded"
              >
                ↺ RESET
              </button>
            </div>
