    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-16">
          <Link href="/demo">
            <button className="btn-solid-cyan flex items-center gap-2">
              <span className="text-[#060D17]">▶</span>
              VER DEMO
            </button>
          </Link>
          <Link href="/trades">
          ...
          <Link href="/agents">
            <button className="inline-flex items-center gap-2 text-white/50 hover:text-[#9B30FF] text-sm font-mono transition-colors border border-white/10 hover:border-[#9B30FF40] px-5 py-3 rounded tracking-widest uppercase">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-white/30 hover:text-white/60 text-sm font-mono transition-colors border border-white/10 hover:border-white/20 px-5 py-3 rounded"
          >
